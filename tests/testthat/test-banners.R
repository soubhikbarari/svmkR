...
# TODO: need to come up with more piecemeal tests rather than just doing the whole vignette

# test_that("banner creation vignette works", {
#   expect_error(data(ev22), NA)
#   expect_error(
#     ev22.coded <- ev22 %>%
#       let(
