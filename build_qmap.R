...
## Age 2 ----
labels <- c("age2", "Age 2")
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(18:44, collapse="|"), ")($| )"), variable_name=labels, variable_level="18 - 44"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(45:100, collapse="|"), ")($| )"), variable_name=labels, variable_level="45 and up"))

## Age 6 ----
labels <- c("age6", "Age 6")
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(18:24, collapse="|"), ")($| )"), variable_name=labels, variable_level="18 - 24"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(25:34, collapse="|"), ")($| )"), variable_name=labels, variable_level="25 - 34"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(35:44, collapse="|"), ")($| )"), variable_name=labels, variable_level="35 - 44"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(45:54, collapse="|"), ")($| )"), variable_name=labels, variable_level="45 - 54"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(55:64, collapse="|"), ")($| )"), variable_name=labels, variable_level="55 - 64"))
qmap <- rbind(qmap, crossing(question_text=qbank, question_choice=paste0("(^", paste0(65:100, collapse="|"), ")($| )"), variable_name=labels, variable_level="65 and up"))

# RACE --------------------------------------------------------------------
message("x RACE")

qbank <- c("(What is your race|Which racial group do you most identify with|What race or ethnicity best describes you|Which race or ethnicity best describes you)")
...
qbank <- c("What is the.*(highest level|last grade).*(school|education).*you.*(completed|attained|finished)")
